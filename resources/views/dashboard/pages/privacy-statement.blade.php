            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    action="{{ route('privacy-statement-update') }}"
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="myeditorinstance-modal-body" name="privacy_statement">{{ $statement->privacy_statement }}</textarea>
                        </div>
